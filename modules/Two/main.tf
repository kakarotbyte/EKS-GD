...
- kind: ServiceAccount
  ...
  namespace: kube-system
 YAML
 depends_on = [ kubectl_manifest.eightpods,module.eks-2]
 }
...
metadata:
  ...
  namespace: kube-system
 YAML
 depends_on = [ kubectl_manifest.RBAC,module.eks-2]
 }
...
spec:
 ...
 YAML
 depends_on = [ kubectl_manifest.serviceAccount,module.eks-2]
 }